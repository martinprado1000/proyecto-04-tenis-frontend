...
import { User, CalendarDays, Trophy, ShieldCheck, CalendarClock, Users, Sun, Moon, BarChart3 } from 'lucide-react'
...
const NAV_ITEMS = [
  ...
  { to: '/estadisticas', label: 'Mis Estadísticas', icon: BarChart3 },
]
  ...
  return (
    ...
    >
      <nav className="flex-1 space-y-1 overflow-y-auto p-3 scrollbar-thin">
                ...
                className={({ isActive }) =>
                  cn(
                    ...
                    isActive
                      ...
                      : 'border-court/40 bg-court/10 text-court-foreground/90 hover:bg-court/20'
                  )
                }
                title={collapsed ? label : undefined}
              >
        ...
        {isAdmin && (
          <>
            <div className={cn('my-3 h-px bg-border', collapsed && 'mx-5')} />
            {!collapsed && (
              <p className="px-3 pb-1 text-[11px] font-semibold uppercase tracking-widest text-court">
                Entrenamientos
              </p>
            ...
            <NavLink
              to="/SystemMP/admin/analisis-deportivo"
              className={({ isActive }) =>
                cn(
                  'flex items-center gap-3 rounded-lg border px-3 py-2.5 text-sm font-semibold transition-colors',
                  isActive
            ...
            >
              ...
              {!collapsed && <span className="truncate">Admin: Analisis deportivo</span>}
            </NavLink>
